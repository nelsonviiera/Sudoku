...
//                    if(matrixSudoku[scrollLine][scrollColumn].getText().equals("") || matrixSudoku[scrollLine][scrollColumn].getForeground().equals(Color.red))
    ...
    private void checkLine(int matrixSudoku[][], int line, int column) {
        for(int scrollColumn = 0; scrollColumn < 9; scrollColumn++) {
...
//                    matrixSudoku[line][column].setForeground(Color.red);
    ...
    private void checkColumn(int matrixSudoku[][], int line, int column) {
        for(int scrollLine = 0; scrollLine < 9; scrollLine++) {
            if(scrollLine == line)
                scrollLine++;
            if(scrollLine < 9) {
...
//                    matrixSudoku[line][column].setForeground(Color.red);
    ...
    private void checkMatrix3x3(int matrixSudoku[][], int line, int column, int lineMatrix3x3, int columnMatrix3x3) {
